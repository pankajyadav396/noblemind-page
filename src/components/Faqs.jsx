        ...
        <>
            <div className='py-sm-5 mt-lg-5 position-relative' id='faqs'>
                ...
                <div className='container-md'>
                    <h1 data-aos="zoom-in" className=' mt-2 mb-0 fw-light color-black1 mb-3 ff-outfit fs-lg text-center'>Frequently <span className="fw-semibold">  Asked Questions</span></h1>
                    <p data-aos="zoom-in" className=' color-black2 max-w-584 ff-exo fs-sm lg-24 fw-normal mt-3 mb-0 text-center mx-auto mb-5'>Lorem ipsum dolor sit amet consectetur. Orci augue mollis eu volutpat mi leo. Nibh nisl consequat metus.</p>
                    <Accordion defaultActiveKey="0" className=' gap-4 border-0 max-w-774 mx-auto'>
                        <Accordion.Item data-aos="fade-up" eventKey="0" className=' mb-3'>
                        ...
                        <Accordion.Item data-aos="fade-up" eventKey="1" className=' mb-3'>
                            <Accordion.Header className='fs-sm fw-medium color-grey ff-outfit'>How does AI benefit our company?</Accordion.Header>
                            <Accordion.Body className='color-black2 fs-sm ff-exo pt-0'>
                                Artificial Intelligence refers to the development of computer systems that can perform tasks that typically require human intelligence. These tasks include learning, reasoning, problem-solving, perception, and language understanding.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item data-aos="fade-up" eventKey="2" className=' mb-3'>
                        ...
                        <Accordion.Item data-aos="fade-up" eventKey="3" className=' mb-3'>
                        ...
                        <Accordion.Item data-aos="fade-up" eventKey="4" className=' mb-3'>
