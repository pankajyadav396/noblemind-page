        ...
        <>
            <div className='pt-sm-5 pb-5 position-relative' id='choose'>
                ...
                <div className='container max-w-1140'>
                    <div data-aos="fade-up" className=' d-flex justify-content-center align-items-center gap-2'>
                        <Star />
                        <p className=' m-0 lh-24 ff-exo color-black1 fw-normal fs-sm'>Why Choose Us</p>
                    </div>
                    <h2 data-aos="fade-up" className='mt-2 mb-0 fw-light lh-57 mb-5 text-center color-black1 ff-outfit fs-lg'>Driving Innovation & <span className='d-block fw-semibold'>Transforming Industries</span></h2>
                    <Swiper breakpoints={{
                        640: {
                            slidesPerView: 2,
                        },
                    ...
                    <img data-aos="zoom-in" src={img2} alt="img" className='w-100 mt-4 img-swiper-sec' />
                </div>
            </div>
        </>
    )
